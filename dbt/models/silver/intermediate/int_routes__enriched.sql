...
joined as (
    ...
    left join airports orig
        on r.source_airport_code = orig.airport_ident
        or r.source_airport_code = orig.iata_code
    left join airports dest
        on r.destination_airport_code = dest.airport_ident
        or r.destination_airport_code = dest.iata_code
)
